...
public class StateCityMain {
	...
	public static void main(String[] args) {
		...
		List<SAQ2City> value=cs.stream().sorted(Comparator.comparing(SAQ2City::getPopulation).
				thenComparing(SAQ2City::getArea_of_city).reversed()).limit(1).collect(Collectors.toList());
		System.out.println(value+"/n");
		
		System.out.println("\n"+"find city with high population index and high city area");
		List<SAQ2City> value1=cs.stream().sorted(Comparator.comparing(SAQ2City::getPollutionIndex)
				.thenComparing(SAQ2City::getArea_of_city).reversed()).limit(1).collect(Collectors.toList());
		...
		List<SAQ2City> value3=cs.stream().sorted(Comparator.comparing( SAQ2City::getPollutionIndex)
				.thenComparing(SAQ2City::getArea_of_city)).limit(1).collect(Collectors.toList());
